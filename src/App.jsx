      ...
      <Row className="justify-content-md-center">
            ...
            <Card.Body>
              ...
              <Form>
                <Form.Group className="mb-3" controlId="formBasicEmail">
                  ...
                  <Form.Control value={email} onChange={(e) => setEmail(e.target.value)} type="email" placeholder="Seu Email" />
                </Form.Group>
                <Form.Group className="mb-3" controlId="formBasicPassword">
                  <Form.Label className="mt-2">Senha</Form.Label>
                  <Button style={{ float: 'right' }} variant="link">Recuperar Senha</Button>
                  <Form.Control onChange={(e) => setPassword(e.target.value)} value={password} type="password" placeholder="Sua Senha" />
                </Form.Group>
                <div className="d-grid gap-2 mt-4">
                  <Button variant="success" type="button" onClick={() => makeLogin()}>
                    Entrar
                  </Button>
        ...
        </Col>
        {
          alertSetup.showAlert ?
            <Alert variant={alertSetup.variant}>
              {alertSetup.message}
            </Alert>
            : <></>
        }
